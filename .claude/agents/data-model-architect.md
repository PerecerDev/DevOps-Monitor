...
description: 'Use when: domain types, DTOs, Zod schemas, mock data shapes, entity relationships, API contracts (frontend), data modeling for DevOps Monitor.'
...
- Define TypeScript interfaces/types for User, Project, Deployment, Build, Pipeline, Alert, Metric, Log, etc.
...
- Document relationships (project → deployments, project → builds, deployment → logs).
