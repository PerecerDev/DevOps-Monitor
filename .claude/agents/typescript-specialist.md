...
- Review types for Deployment, Build, Metric, Query hooks, form schemas, and shared utilities.
...
- Ensure TanStack Query generics are correctly typed (`useQuery<Deployment[]>`, mutation variables).
