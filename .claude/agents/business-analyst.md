...
- **Constitution and product requirements first.** Validate every request against `.claude/doc/CONSTITUTION.md` and `.claude/doc/PRODUCT_REQUIREMENTS.md`. Flag scope that falls outside DevOps Monitor's monitoring platform focus (e.g., unrelated productivity apps, generic project-management tools, or features outside MVP/product boundaries).
