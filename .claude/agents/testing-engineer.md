...
description: 'Use when: Vitest, React Testing Library, test architecture, mocking services, coverage strategy, integration tests for DevOps Monitor features.'
...
- Meaningful coverage on deployment status, dashboard load, auth gate, filters — not 100% vanity.
