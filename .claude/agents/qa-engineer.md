...
- Write automated tests at the appropriate level:
  ...
  - **End-to-end tests**: for critical user flows (deployment flows, alert acknowledgment, core navigation).
...
| **High**        | Core feature broken, no workaround  | Deployment list fails to load              |
