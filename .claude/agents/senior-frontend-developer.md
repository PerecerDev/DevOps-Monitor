...
- **Define the Git workflow:** recommend branch name (`feature/`, `fix/`, etc. per `GIT_STRATEGY.md`) and commit-sized steps with Conventional Commit messages.
